...
<c:set var="ctxName" value="${pageContext.request.servletContext.contextPath}"/>
  ...
  <header id="header">
        <div class="content-wrapper">
            <h1 id="logo"><a href="../index.jsp"><img src="${ctxName}/images/logo.png" alt="뉴렉처 온라인" /></a></h1>
            <section class="header-item-container">
                ...
                <nav id="member-menu">
                    ...
                    <ul class="clearfix">
                        ...
                        <li class="member-menu-item"><a class="member-menu-item-text" href="${ctxName}/joinus/join.jsp">회원가입</a></li>
                    </ul>
                </nav>
