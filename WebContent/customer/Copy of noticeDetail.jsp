            ...
            <main id="main">
                ...
                <article id="notice-detail" class="space-top-l">
                    ...
                    <dl>
                        ...
                        <dd class="detail-cell text-highlight"><%=rs.getString("TITLE") %></dd>
                        <dt class="detail-cell title newrow">작성일</dt>
                        <dd class="detail-cell"><%=rs.getString("REGDATE") %></dd>
                        <dt class="detail-cell title newrow">작성자</dt>
                        <dd class="detail-cell half-cell"><%=rs.getString("WRITER") %></dd>
                        <dt class="detail-cell title">조회수</dt>
                        <dd class="detail-cell half-cell"><%=rs.getInt("HIT") %></dd>
