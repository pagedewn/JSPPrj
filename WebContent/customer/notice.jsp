...
<%
	...
	if (_q != null && !_q.equals("q"))
		nquery = _q;

	if (_field != null && !_field.equals(""))
		nfield = _field;

	list = noticeDao.getNotices(npage,nquery,nfield);
                    ...
                    <div id="search-form">
                        ...
                        <form action="notice.jsp" method="get">
                            <fieldset>
                                ...
                                <label for="f" class="hidden">검색분류</label>
                                <select class="search-field" name="f">
                                    <option ${param.f=='TITLE'?'selected':null} value="TITLE">제목</option>
                                    <option ${param.f=='WRITER'?'selected':null} value="WRITER">작성자</option>
                                    <option ${param.f=='CONTENT'?'selected':null} value="CONTENT">내용</option>
                                </select>
                                <label for="q" class="hidden">검색어필드</label>
